...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative h-screen md:h-[600px] bg-cover bg-center mt-0 pt-14 md:pt-18" style={{ backgroundImage: "url('/images/hero-bg.jpg')", paddingTop: 'env(safe-area-inset-top, 0px)' }}>
