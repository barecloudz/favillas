-- Favilla's NY Pizza Menu Import - SAFE VERSION
...
-- First, get the next available order number to avoid conflicts
DO $$
DECLARE
    next_order_num integer;
BEGIN
    -- Get the highest order number currently in use, default to 0 if no categories exist
    SELECT COALESCE(MAX("order"), 0) + 1 INTO next_order_num FROM categories;

    -- Insert categories with sequential order numbers starting from next available
...
-- APPETIZERS (only add if they don't exist)
INSERT INTO menu_items (name, description, base_price, category, is_available)
SELECT 'Mozzarella Sticks Appetizer', '6 Mozzarella Sticks Served with homemade marinara.', 8.99, 'Appetizers', true
WHERE NOT EXISTS (SELECT 1 FROM menu_items WHERE name = 'Mozzarella Sticks Appetizer');

INSERT INTO menu_items (name, description, base_price, category, is_available)
SELECT 'Fried Zucchini Sticks Appetizer', 'Served with roasted red pepper sauce', 8.99, 'Appetizers', true
WHERE NOT EXISTS (SELECT 1 FROM menu_items WHERE name = 'Fried Zucchini Sticks Appetizer');

INSERT INTO menu_items (name, description, base_price, category, is_available)
SELECT 'Wings Appetizer', '6 wings with 7 flavours to choose from.', 11.99, 'Appetizers', true
WHERE NOT EXISTS (SELECT 1 FROM menu_items WHERE name = 'Wings Appetizer');

INSERT INTO menu_items (name, description, base_price, category, is_available)
SELECT 'Meatballs & Sausage Appetizer', 'Served with Melted Mozzarella & Garlic Rolls.', 9.95, 'Appetizers', true
WHERE NOT EXISTS (SELECT 1 FROM menu_items WHERE name = 'Meatballs & Sausage Appetizer');

INSERT INTO menu_items (name, description, base_price, category, is_available)
SELECT 'Chicken Fingers Appetizer', 'Served with French Fries.', 9.99, 'Appetizers', true
WHERE NOT EXISTS (SELECT 1 FROM menu_items WHERE name = 'Chicken Fingers Appetizer');

INSERT INTO menu_items (name, description, base_price, category, is_available)
SELECT 'Spinach Pinwheels Appetizer', 'Spinach with ricotta and mozzarella cheese.', 4.95, 'Appetizers', true
WHERE NOT EXISTS (SELECT 1 FROM menu_items WHERE name = 'Spinach Pinwheels Appetizer');

INSERT INTO menu_items (name, description, base_price, category, is_available)
SELECT 'Garlic Knot Sliders Appetizer', '', 4.50, 'Appetizers', true
WHERE NOT EXISTS (SELECT 1 FROM menu_items WHERE name = 'Garlic Knot Sliders Appetizer');

INSERT INTO menu_items (name, description, base_price, category, is_available)
SELECT 'Pepperoni Pinwheel', 'Pepperonis and meatballs with ricotta and mozzarella cheese', 4.95, 'Appetizers', true
WHERE NOT EXISTS (SELECT 1 FROM menu_items WHERE name = 'Pepperoni Pinwheel');

-- SIDES (only add if they don't exist)
...
-- TRADITIONAL PIZZA (only add if they don't exist)
INSERT INTO menu_items (name, description, base_price, category, is_available) VALUES
...
-- GRANDMAS STYLE PIZZAS (only add if they don't exist)
INSERT INTO menu_items (name, description, base_price, category, is_available) VALUES
...
-- 10" SPECIALTY GOURMET PIZZAS (only add if they don't exist)
INSERT INTO menu_items (name, description, base_price, category, is_available) VALUES
...
-- 14" SPECIALTY GOURMET PIZZAS (only add if they don't exist)
INSERT INTO menu_items (name, description, base_price, category, is_available) VALUES
...
-- 16" SPECIALTY GOURMET PIZZAS (only add if they don't exist)
INSERT INTO menu_items (name, description, base_price, category, is_available) VALUES
...
-- SICILIAN SPECIALTY GOURMET PIZZAS (only add if they don't exist)
INSERT INTO menu_items (name, description, base_price, category, is_available) VALUES
...
-- SALADS (only add if they don't exist)
INSERT INTO menu_items (name, description, base_price, category, is_available) VALUES
...
-- CALZONES (only add if they don't exist)
INSERT INTO menu_items (name, description, base_price, category, is_available) VALUES
...
-- STROMBOLIS (only add if they don't exist)
INSERT INTO menu_items (name, description, base_price, category, is_available) VALUES
...
-- DRINKS (only add if they don't exist)
INSERT INTO menu_items (name, description, base_price, category, is_available) VALUES
...
-- DESSERTS (only add if they don't exist)
INSERT INTO menu_items (name, description, base_price, category, is_available) VALUES
...
-- GLUTEN FREE CRUST 10" SPECIALTY GOURMET PIZZAS (only add if they don't exist)
INSERT INTO menu_items (name, description, base_price, category, is_available) VALUES
...
-- DOUGH BALLS (only add if they don't exist)
INSERT INTO menu_items (name, description, base_price, category, is_available) VALUES
...
SELECT 'Total menu items:' as info, COUNT(*) as count FROM menu_items;